...
\begin{figure*}
\centering\includegraphics[width=\textwidth]{espectros01.pdf}
...
Fig.~\ref{fig:ejemplosEspectros21} shows some example spectra from 
this dataset. In this validity analysis, efforts were focused on the 
effective temperature.


\begin{figure*}
\centering\includegraphics[width=\textwidth]{espectros02.pdf}
\caption{Example spectra from the second dataset (the nominal GIRAFFE 
HR21 setup).}
\label{fig:ejemplosEspectros21}
\end{figure*}
...
\begin{figure*}
\centering\includegraphics[width=.9\textwidth]{flamesHR10_Teff_log_BestSVM_N-RMSE_test.pdf}
...
\begin{figure*}
\centering\includegraphics[width=.9\textwidth]{flamesHR10_Logg_BestSVM_N-RMSE_test.pdf}
...
\begin{figure*}
\centering\includegraphics[width=.9\textwidth]{flamesHR10_Meta_BestSVM_N-RMSE_test.pdf}
...
\begin{figure*}
\centering\includegraphics[width=.9\textwidth]{flamesHR10_AlFe_BestSVM_N-RMSE_test.pdf}
...
\begin{figure}
\centering\includegraphics[width=\columnwidth]{flamesHR10_SNR=000_Logg_BestSVM_N-RMSE_test.pdf}
...
\begin{figure}
\centering\includegraphics[width=\columnwidth]{flamesHR10_SNR=000_Meta_BestSVM_N-RMSE_test.pdf}
...
\begin{figure}
\centering\includegraphics[width=\columnwidth]{flamesHR10_SNR=000_AlFe_BestSVM_N-RMSE_test.pdf}
...
\begin{figure}
\centering\includegraphics[width=\columnwidth]{flamesHR21_SNR=000_Teff_log_BestSVM_N-RMSE_test.pdf}
\caption{Temperature estimation error as a function of the number of
  dimensions used for data compression, for synthetic spectra from 
  the second dataset}
\label{fig:noiseless-teff-hr21}
\end{figure}
