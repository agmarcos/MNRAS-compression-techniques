...
\item For lower SNR data, the optimality criterion translates into
	...
	\cite{Bailer-Jones1998} in the case of {\bf PCA compression of spectra.} 
	Our results extend this conclusion to other compression 
	techniques when the wavelength coverage is {\bf greater} than 300 {\AA}.
...
%{\bf PCA and ICA show a similar behaviour 
%	with the grid density variation. The grid density appears to have less effect over the
%    performance of Wavelets and diffusion maps.
%}

{\bf TO BE DONE: compare with Fig. \ref{fig:02} and explain the different conclusions. See email to ana.}
...
\cite{vanGestel2004}. Of course, the no-free-lunch theorem \citep[see][and 
...
\section{Effective temperature regression errors grouped by compression technique for SNR=25 and 100}
\label{a2}
